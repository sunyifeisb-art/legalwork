...
describe('create_plan tool mapping', () => {
  ...
  it('surfaces create_plan tool events through the event sink', () => {
    ...
    void dispatchLegalworkRuntimeEvent(event, sink, async () => undefined)
...
describe('Legalwork extension metadata mapping', () => {
...
describe('tool presentation inference', () => {
  it('prefers explicit toolKind from Legalwork over local heuristics', () => {
    const block = chatBlockFromItem({
