...
## 一、核心概念
> **重要原则：** 本技能提供的是一种结构化论证思路，不是强制模板。法律文书的最终表达应当根据案件特点、受众和诉讼策略灵活选择，可以综合运用三段论、证据链论证、类比论证、归谬论证、价值衡量等多种方法。严禁在每一份文书中机械套用固定格式，尤其禁止在上诉状、代理词、辩护词等诉讼文书中逐条标注“法律依据—事实依据—结论”。
...
> **重要：** 三段论（法律依据-事实依据-结论）是检验论证逻辑有效性的内部工具，不是法律文书的唯一写法。起草上诉状、代理词、辩护词等诉讼文书时，应优先采用法官易于接受的叙事和论证节奏：先点明主张，再陈述关键事实与证据，最后援引法律规范得出结论。严禁在每一份文书中机械套用“法律依据：……；事实依据：……；结论：……”的固定格式。
