...
description: |
  基于中国人民法院裁判文书制作规范，起草完整的民事判决书或刑事判决书。当用户要求"起草判决书"、"生成裁判文书"、"写民事判决书"、"写刑事判决书"、"根据案卷写文书"或提供案卷材料要求输出裁判文书时使用本技能，在起草各段落时自主调用原子技能（如争议焦点识别、法条检索、法律论证与推理、证据效力评估等）。
---
...
| 4 | `论证链条构建`（Skill #15） | 根据争议焦点、文书类型和案件特点，灵活选择论证方式，如自然语言说理、证据链论证、类案论证、价值衡量等。不得强制采用三段论或任何僵化格式；上诉状、代理词、辩护词等应围绕争议焦点叙事，突出错误点、改判/支持理由 |
...
| 3 | `论证链条构建`（Skill #15） | 根据文书类型和案件特点灵活选择论证方式，如自然语言说理、证据链论证、类案论证等。不得强制采用三段论或任何僵化格式；上诉状、辩护词等应突出一审认定事实或适用法律错误 |
...
**法律论证：**
-   **货款本金**：合同有效且原告已履行交货义务，贸易公司认可欠付 1123685.86 元，依据《民法典》第 509 条、第 626 条，贸易公司应当支付该货款。
-   **违约金标准**：原告已将日 1‰ 违约金降至一年期 LPR 四倍，贸易公司未举证证明该标准过分高于实际损失，依据《民法典》第 585 条及买卖合同司法解释相关规定，该违约金标准可予支持。
-   **违约金起算**：贸易公司未按《付款计划书》于 2024 年 11 月 25 日支付首笔款项，构成违约，但结合案件事实，违约金自 2024 年 12 月 26 日起算更为合理。
-   **连带责任**：郑某在保证函中签字承诺承担连带保证责任，且无免责情形，依据《民法典》第 688 条，郑某应当对贸易公司的债务承担连带责任。
...
**法律论证：**
-   **非吸金额认定**：在案证据能够证实本案系共同犯罪，非法吸收资金共计 1 亿余元，亲属投资部分无扣除法定依据，依据《刑法》第 176 条、第 25 条，涉案金额不予扣除，认定为数额特别巨大。
-   **自首认定**：杨某 1 虽经电话传唤到案，但未第一时间交代主要犯罪事实，不符合主动投案并如实供述的要件，依据《刑法》第 67 条第 1 款，不构成自首；其后续如实供述可认定为坦白。
-   **从犯认定**：杨某 1 系集团下属部门负责人，在共同犯罪中起次要、辅助作用，依据《刑法》第 27 条，可认定为从犯，依法减轻处罚。
-   **缓刑适用**：本案非法吸收资金数额特别巨大，社会危害性较大，不符合犯罪情节较轻、无再犯危险等缓刑适用条件，依法不适用缓刑。
-   **从宽处罚**：杨某 1 认罪认罚、具有坦白情节，并退缴全部违法所得，依据《刑事诉讼法》第 15 条、《刑法》第 67 条第 3 款，可依法从宽处罚。
...
| 事实与理由部分 | 论证链条构建 | #15 | 根据文书类型和案件特点灵活选择自然语言论证，不得强制采用三段论等僵化格式 |
