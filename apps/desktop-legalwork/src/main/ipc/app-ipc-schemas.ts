...
import {
  ...
  LEGALWORK_KNOWLEDGE_CLASSIFY_TEMPLATE,
  ...
  LEGALWORK_KNOWLEDGE_RETRIEVE_TEMPLATE,
...
const ENDPOINTS: readonly EndpointTemplate[] = [
  ...
  compileEndpoint(LEGALWORK_KNOWLEDGE_RETRIEVE_TEMPLATE, ['GET']),
  ...
  compileEndpoint(LEGALWORK_KNOWLEDGE_CLASSIFY_TEMPLATE, ['POST']),
