 ...
 * `create_plan` tool result. Mirrors the Legalwork output contract
 ...
 * reserved plan id, workspace root, and relative path the Legalwork
...
/**
 * Native Legalwork plan tool name. Re-exported alongside the shared
