/**
 * Legalwork-side mirror of the shared GUI plan contract from
 * DeepSeek-GUI's `src/shared/gui-plan.ts`.
 *
 * The renderer and the Legalwork package live in the same repo but
 * TypeScript's `rootDir` constraint prevents Legalwork from
