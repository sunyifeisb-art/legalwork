...
export const LegalworkCapabilitiesConfig = z
  .object({
  ...
  .strict()
export type LegalworkCapabilitiesConfig = z.infer<typeof LegalworkCapabilitiesConfig>

export const DEFAULT_LEGALWORK_CAPABILITIES_CONFIG: LegalworkCapabilitiesConfig = LegalworkCapabilitiesConfig.parse({})
...
export function buildRuntimeCapabilityManifest(input: {
  config?: LegalworkCapabilitiesConfig
  model: ModelCapabilityMetadata
  mcp?: {
  ...
  const config = LegalworkCapabilitiesConfig.parse(input.config ?? {})
